...
import { Home, Zap, Code, Smartphone, Award, Sparkles, ChevronLeft, User, Map } from 'lucide-react';
      ...
      <div className="bg-slate-800 border-b border-slate-700">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <Link href="/home">
              <a className="flex items-center text-rose-400 hover:text-rose-300 transition-colors">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/profile">
                <a className="p-2 rounded-full hover:bg-slate-700 transition-colors">
                  <User className="h-5 w-5 text-gray-400 hover:text-rose-400 transition-colors" />
                </a>
              </Link>
              <Link href="/badges">
                <a className="p-2 rounded-full hover:bg-slate-700 transition-colors">
                  <Award className="h-5 w-5 text-gray-400 hover:text-rose-400 transition-colors" />
                </a>
              </Link>
              <Link href="/map">
                <a className="p-2 rounded-full hover:bg-slate-700 transition-colors">
                  <Map className="h-5 w-5 text-gray-400 hover:text-rose-400 transition-colors" />
                </a>
              </Link>
            </div>
          </div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 pt-8">
            ...
            >
              <div className="w-20 h-20 text-rose-400 mx-auto flex items-center justify-center text-6xl">
                🤝
              </div>
            </motion.div>
            ...
            <motion.h1
              ...
              style={{ 
                backgroundImage: ubuntuTheme.gradients.glow,
                textShadow: '0 0 15px rgba(225, 29, 72, 0.3)'
              }}
            >
            ...
            <motion.p
              ...
              className="mt-4 text-xl text-rose-100 max-w-3xl mx-auto"
            >
              Explore the practical applications of Bitcoin across Africa through the spirit of Ubuntu - "I am because we are."
            </motion.p>
          </div>
          ...
          <div className="mt-10 flex justify-center">
            <button
              ...
              className="px-6 py-2 bg-slate-800 text-white rounded-lg hover:bg-slate-700 transition-colors border border-slate-600"
            >
              Return to Journey
            </button>
          </div>
